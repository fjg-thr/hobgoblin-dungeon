...
- Next.js client/server boundaries: Phaser and browser globals must stay in client-only code paths, and dynamic imports should not create server-rendering crashes.
...
- Accessibility and UI shell: changes in `src/app/**` or React components should keep keyboard/browser behavior intact and avoid hiding the game canvas from assistive technology without intent.
