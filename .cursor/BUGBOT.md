...
- Confirm keyboard and pointer controls remain accessible in-game: movement uses WASD or arrow keys, shooting is bound to Space and pointer/click firing in code.
