...
- For UI/HUD or input changes, check keyboard, mouse, pause/mute, restart, and resize flows. Preserve accessibility in the surrounding Next/React shell where applicable.
