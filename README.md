...
Cursor Bugbot review guidance lives in `.cursor/BUGBOT.md`. Managed Bugbot enablement is configured outside this repository through Cursor and GitHub App settings.
