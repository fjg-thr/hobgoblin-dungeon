...
- Generated and processed asset tooling lives in both `tools/` and `scripts/`.
  ...
  generation, and retro soundtrack generation.
...
5. **User-facing controls and accessibility:** Keep the start screen, how-to-play
   modal, mute control, and pointer/keyboard flows usable.
