...
4. **Assets and metadata**
   ...
   - `src/app/layout.tsx` references `/opengraph-image.png`, but the asset is not currently tracked. Treat this as existing metadata debt unless a PR touches metadata, sharing, or public assets.
