...
- `src/app/layout.tsx` references `/opengraph-image.png`, and `public/opengraph-image.png` is currently present. Flag metadata changes that break that path, dimensions, or alt text consistency.
