...
If the local toolchain or automation environment blocks one of these commands, report that limitation explicitly and continue reviewing the diff with the strongest available evidence.
