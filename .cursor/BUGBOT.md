...
- The title screen includes a Phaser-rendered how-to-play modal. Review changes
  to the modal, start screen, or control copy for compact viewport layout,
  pointer hit zones, close behavior, and consistency with runtime controls.
...
- For this Bugbot deployment guide itself, the expected repository diff is only
  `.cursor/BUGBOT.md`; runtime source, generated assets, dependencies,
  lockfiles, and workflows should remain untouched.
