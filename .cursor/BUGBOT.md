...
- Existing baseline context: `src/app/layout.tsx` references `/opengraph-image.png`, but no matching file currently exists under `public/`. If metadata or public asset inventory changes, verify that the referenced image exists and remains appropriate.
