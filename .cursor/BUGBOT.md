...
- App-level metadata, including OpenGraph and Twitter card settings, lives in `src/app/layout.tsx`.
...
- For metadata or share-card changes, verify URLs resolve correctly in local, Vercel, and configured `NEXT_PUBLIC_SITE_URL` environments.
