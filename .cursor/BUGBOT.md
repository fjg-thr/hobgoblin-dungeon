...
1. **Client/server boundaries**
   ...
   - Keep Phaser, `window`, `document`, pointer, keyboard, audio, canvas, and other browser-only APIs out of server components and module paths that Next.js may evaluate during server rendering.
