...
2. **Runtime asset integrity**: Any changed path in `assetManifest` must correspond to a tracked public asset and, when metadata is used, a matching JSON file with frame sizes that align with the loader calls.
