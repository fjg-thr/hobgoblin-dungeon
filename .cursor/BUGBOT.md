...
itself. Confirm deployment outside this repo through Cursor Bugbot settings,
Cursor GitHub App access to this repository, any admin/API team configuration,
and a live pull-request smoke review after this file is merged to the default
branch.

Bugbot includes the root `.cursor/BUGBOT.md` for reviews and can also include
nested `subdir/.cursor/BUGBOT.md` files for changes under that subtree. These
rules are combined with team, repository, and user rules.
