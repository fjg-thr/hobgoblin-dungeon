...
- Cursor Bugbot itself is a managed Cursor/GitHub App service. Enabling it for this
  repository requires the Cursor dashboard or organization settings plus GitHub App
  repository access; this file only supplies repo-side review instructions.
...
- This is a private Next.js/React/TypeScript prototype using Phaser 4 for the runtime game.
