...
- This is a private npm-package Next.js App Router prototype deployed from GitHub.
- React owns page and layout composition while Phaser owns the game loop, scene, sprites, input, and audio state.
