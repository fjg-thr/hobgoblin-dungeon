...
- `src/app/layout.tsx` currently references `/opengraph-image.png`. Flag
  metadata/share-image changes that add broken public asset references, remove a
  referenced asset, or drift from expected image dimensions/alt text.
