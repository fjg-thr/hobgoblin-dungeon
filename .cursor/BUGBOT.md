...
- Metadata image paths must match committed files under `public/`. Changes near
  `src/app/layout.tsx` should ensure Open Graph and Twitter image references
  exist or update the metadata to point at committed assets.
